...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-backup-for-dev-only')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'tmonarco.pythonanywhere.com']

CSRF_TRUSTED_ORIGINS = ['https://tmonarco.pythonanywhere.com']
